...
import { fadeUp, slideInLeft, slideInRight, viewportConfig } from '@/lib/motion'
    ...
    <section className="py-20 md:py-28 px-4 sm:px-6 relative bg-white border-y border-[#E7E7EE]">
      <div className="max-w-7xl mx-auto relative z-10">
        <SectionHeader
          ...
          subhead="The PDF in the inbox. The deck buried three threads deep. The silence after the demo. That's where deals are won or lost."
        />
